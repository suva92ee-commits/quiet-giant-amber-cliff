...
//#region node_modules/.nitro/vite/services/ssr/assets/portfolio-bf4LZNP3.js
...
function Waveform({ peaks, progress, className, onSeek }) {
	const bars = (0, import_react.useMemo)(() => peaks.length ? peaks : Array.from({ length: 96 }, () => .12), [peaks]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		tabIndex: onSeek ? 0 : void 0,
		onClick: onSeek ? (e) => {
			const rect = e.currentTarget.getBoundingClientRect();
			onSeek(Math.min(1, Math.max(0, (e.clientX - rect.left) / rect.width)));
		} : void 0,
		children: bars.map((v, i) => {
...
async function loadPeaks() {
	...
	try {
		const data = await (await fetch("/audio/peaks.json")).json();
		Object.assign(peaksCache, data);
	} catch {}
	return peaksCache;
}
function AudioPlayer({ id, src, title, compact = false, className }) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (!el) return;
		if (isActive) el.play().catch(() => pause());
		else el.pause();
	}, [isActive, pause]);
	(0, import_react.useEffect)(() => {
		const el = audioRef.current;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: isActive ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "size-4 fill-current" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "size-4 fill-current ml-0.5" })
			}),
				...
				children: [
					!compact && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [
								formatTime((audioRef.current?.currentTime ?? 0) || progress * duration),
								" / ",
								formatTime(duration)
							]
						})]
...
function Badge({ className, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("inline-flex items-center rounded-full px-2.5 py-1 text-[11px] font-medium tracking-wide text-muted shadow-[var(--shadow-border)]", className),
		children
	});
}
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-[opacity,transform,background-color,box-shadow] duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70 focus-visible:ring-offset-2 focus-visible:ring-offset-bg disabled:pointer-events-none disabled:opacity-40 active:scale-[0.98]", {
	variants: {
		variant: {
...
var profile = {
	...
	languages: [
		{
			name: "Hindi",
			level: "Native — accents, dialects, regional variation"
		},
		{
			name: "English",
			level: "Proficient (B2+) — clear studio delivery"
		},
		{
			name: "Bengali",
			level: "Native — informs Eastern Hindi rhythm"
		}
	]
};
var samples = [
	{
		...
		scriptHi: "नमस्कार। मेरा नाम सुवदीप मल्लिक है, और मैं पश्चिम बंगाल से एक ऑडियो प्रोडक्शन स्पेशलिस्ट हूँ। पिछले दस वर्षों में मैंने एक हज़ार से ज़्यादा लाइव इवेंट्स पर साउंड क्वालिटी का काम किया है। मेरा कान आवाज़ के छोटे-छोटे फ़र्कों को पकड़ता है — उच्चारण, सुर, लय, और रिकॉर्डिंग की साफ़-सफ़ाई। यही कौशल अब मैं एआई ट्रेनिंग डेटा की क्वालिटी पर लगाना चाहता हूँ।",
		scriptEn: "A measured broadcast register. Even pace, closed /a/ toward standard Hindustani, full retroflexes, no filled pauses. This is the gold-speech baseline I compare other takes against.",
		transcript: "Namaskār. Merā nām Suvadeep Mallik hai, aur main Paścim Bangāl se ek audio production specialist hū̃. Pichle das varṣõ mẽ maine ek hazār se zyādā live events par sound quality kā kām kiyā hai. Merā kān āvāz ke chote-chote farkõ ko pakaṛtā hai — uccāraṇ, sur, lay, aur recording kī sāf-safāī. Yahī kauśal ab main AI training data kī quality par lagānā cāhtā hū̃.",
		annotations: [
			{
				label: "Register",
				note: "Broadcast. Falling declaratives. No disfluency."
			},
			{
				label: "Phonetics",
				note: "Clear retroflex ṭ/ḍ/ṛ. Aspirated kh/th retained."
			},
			{
				label: "Prosody",
				note: "Phrase-final falls. Stress on content words: दस, हज़ार, कान."
			},
			{
				label: "Quality",
				note: "Studio dry. Use as gold / reference, not as 'noisy speech' data."
			}
		],
	...
	},
	{
		...
		lang: "hi",
		tags: ["Hindi"],
		scriptHi: "अरे वो जो कल वाली टेक थी ना... मतलब माइक थोड़ा ज़्यादा पास था, तो 'प' और 'ब' पे पॉप आ गया। मैंने गेन थोड़ा नीचे किया, पॉप फ़िल्टर ठीक से सेट किया, और फिर से लिया। अब वो टेक बिल्कुल क्लियर है, नेचुरल भी लग रही है। कभी-कभी एक छोटी सी जगह बदलने से पूरा फ़र्क पड़ जाता है।",
		scriptEn: "A humanised read: discourse particles (अरे, ना, मतलब), a trailing pause, then a repair. This is the speech models fail on if they only see news-reader Hindi.",
		transcript: "Are vo jo kal vālī take thī nā... matlab mic thoṛā zyādā pās thā, to 'pa' aur 'ba' pe pop ā gayā. Maine gain thoṛā nīce kiyā, pop filter ṭhīk se set kiyā, aur phir se liyā. Ab vo take bilkul clear hai, natural bhī lag rahī hai. Kabhī-kabhī ek choṭī sī jagah badalne se pūrā fark paṛ jātā hai.",
		annotations: [
			{
				label: "Disfluency",
				note: "Filled pause ना... and discourse marker मतलब. Keep, do not strip."
			},
			{
				label: "Code-mix",
				note: "take, mic, gain, pop filter, set, clear, natural — English tech nouns in Hindi syntax."
			},
			{
				label: "Plosives",
				note: "The script names the problem (प/ब pop) that close-mic cardioid recording creates."
			},
			{
				label: "Use",
				note: "Good for conversational ASR and for teaching a model that engineers talk like this."
			}
		],
	...
	},
	{
		...
		scriptHi: "देखो, लाइव साउंड में रूम का अकॉस्टिक सबसे बड़ा फ़ैसला होता है। पश्चिम बंगाल में बहुत से आउटडोर प्रोग्राम होते हैं — हवा, भीड़ का शोर, जनरेटर... सब माइक में आता है। तब किताब से नहीं, कान से फ़ैसला करना पड़ता है। क्या रखना है, क्या काटना है, और कब कहना है कि ये टेक काम की नहीं है, दोबारा रिकॉर्ड करो।",
		scriptEn: "The working register of a live engineer in Bengal. Open vowels, Bangla-leaning rhythm, lists of real noise sources. This is how independent judgement sounds in the field.",
		transcript: "Dekho, live sound mẽ room kā acoustic sabse baṛā faislā hotā hai. Paścim Bangāl mẽ bahut se outdoor program hote haĩ — havā, bhīṛ kā śor, generator... sab mic mẽ ātā hai. Tab kitāb se nahī̃, kān se faislā karnā paṛtā hai. Kyā rakhnā hai, kyā kāṭnā hai, aur kab kahnā hai ki ye take kām kī nahī̃ hai, dobārā record karo.",
		annotations: [
			{
				label: "Accent",
				note: "Eastern Hindi. Softer sibilants, more open /a/, Bangla-timed rhythm. Not 'wrong' Hindi."
			},
			{
				label: "Named noise",
				note: "Wind, crowd, generator — the exact interferers Dialogue Isolate is trained on."
			},
			{
				label: "Judgement",
				note: "Explicit reject class: ये टेक काम की नहीं है. Models need this decision, not only cleanup."
			}
		],
	...
	},
	{
		...
		scriptEn: "Intra-sentential mixing: Hindi grammar with English measurement language (dBFS, clipping, headroom, 48 kHz / 24-bit). Common in Indian studios. ASR that cannot hold both languages in one utterance will hallucinate numbers.",
		transcript: "Gain staging bahut zaroori hai. Peak agar minus six dBFS ke upar chala gaya to clipping ho jayega. I always leave headroom, khas kar live mein, kyunki surprise peaks aate rehte hain. Forty eight kilohertz, twenty four bit — yahi mera default capture hai. Post mein bahut kuch theek kiya ja sakta hai. Clipping nahi.",
		annotations: [
			{
				label: "Switch points",
				note: "Full English clause 'I always leave headroom' inside Hindi discourse."
			},
			{
				label: "Numerals",
				note: "minus six / forty eight / twenty four — must transcribe as said, not normalised."
			},
			{
				label: "Risk",
				note: "A model trained only on 'pure' Hindi will drop dBFS or invent a Hindi number word."
			}
		],
	...
	},
	{
		...
		lang: "hi",
		tags: ["Hindi", "Prosody"],
		scriptHi: "कभी-कभी आवाज़ में थकान होती है। कभी हल्की झुंझलाहट, कभी मुस्कान। अगर मॉडल को इंसान जैसी बात करनी है, तो डेटा में ये भावनाएँ असली होनी चाहिए। नकली smoothness से काम नहीं चलता। आवाज़ में साँस, ठहराव, और वो छोटी-छोटी गलतियाँ — वही उसे इंसान बनाती हैं।",
		scriptEn: "Lower intensity, longer pauses, lexical emotion. This is the take I would label for affect: fatigue, irritation, smile in the voice. Over-limiting this file would destroy the thing a voice model needs.",
		transcript: "Kabhī-kabhī āvāz mẽ thakān hotī hai. Kabhī halkī jhunjhlāhaṭ, kabhī muskān. Agar model ko insān jaisī bāt karnī hai, to data mẽ ye bhāvnāẽ asalī honī cāhie. Naklī smoothness se kām nahī̃ caltā. Āvāz mẽ sā̃s, ṭhahrāv, aur vo choṭī-choṭī galtiyā̃ — vahī use insān banātī haĩ.",
		annotations: [
			{
				label: "Affect",
				note: "Fatigue → mild irritation → smile. Label spans, do not flatten."
			},
			{
				label: "Breath",
				note: "Keep breaths. Breath Control in RX is a mix tool, not a training-data tool."
			},
			{
				label: "Anti-pattern",
				note: "AI 'voice enhance' often removes the micro-variation this file is for."
			}
		],
	...
	},
	{
		...
		lang: "hi",
		tags: ["Hindi", "Prosody"],
		scriptHi: "क्या आपने सुना? ये टेक काम की है, या दोबारा लेनी चाहिए? सिबिलेंस थोड़ा आगे बढ़ा है, ना कमरा है? और वो जो 'वाला' बोला, क्या वह पूर्वी हिंदी का वाला है, या मानक मानक का?",
		scriptEn: "Yes/no questions in Hindi typically rise on the last content word. A model that only sees declaratives will flatten this. Also a metalinguistic question about वाला — dialect, not error.",
		transcript: "Kyā āpne sunā? Ye take kām kī hai, yā dobārā lenī cāhie? Sibilance thoṛā āge baṛhā hai, nā kamrā hai? Aur vo jo 'vālā' bolā, kyā vah pūrvī Hindī kā vālā hai, yā mānak mānak kā?",
		annotations: [{
			label: "Intonation",
			note: "Terminal rise on सुना / चाहिए / है. Annotate as interrogative, not as uncertainty."
		}, {
			label: "Linguistic",
			note: "'वाला' as dialect marker vs standard. Do not correct."
		}],
	...
	},
	{
		...
		lang: "hi",
		tags: ["Hindi", "Accent"],
		scriptHi: "ये वाक्य सुनिए। वक्ता पूर्वी भारत से लगता है। 'स' थोड़ा नरम है, 'अ' थोड़ा खुला है, और लय बांग्ला की तरफ़ झुकती है। ये ग़लत हिंदी नहीं है। ये क्षेत्रीय हिंदी है, और मॉडल को इसे पहचानना चाहिए, सुधारना नहीं।",
		scriptEn: "A spoken style-guide for annotators: regional Hindi is a label, not a defect. LAHAJA-style Hindi ASR work shows North-East and eastern speakers are exactly where models degrade. The job is to hear that, not 'fix' it.",
		transcript: "Ye vākya sunie. Vaktā pūrvī Bhārat se lagtā hai. 'sa' thoṛā naram hai, 'a' thoṛā khulā hai, aur lay Bānglā kī taraf jhuktī hai. Ye galat Hindī nahī̃ hai. Ye kṣetrīya Hindī hai, aur model ko ise pahcānnā cāhie, sudhārnā nahī̃.",
		annotations: [{
			label: "Policy",
			note: "Identify, do not standardise. Accent is a feature."
		}, {
			label: "Cues",
			note: "Softer /s/, open /ə~a/, Bangla-timed rhythm — typical of Bengal Hindi."
		}],
	...
	},
	{
		...
		scriptEn: "Not my voice — a second speaker, informal domestic Hindi. Portfolio work is also evaluation of other people. Reduplication (वाली वाली) is a real Hindi intensification pattern, not a stutter.",
		transcript: "Suno, bāzār se dhaniyā aur harī mirc lete ānā. Vo vālī vālī nahī̃, tāzī vālī. Aur hā̃, dahī khaṭṭā nahī̃ honā cāhie, samjhe?",
		annotations: [
			{
				label: "Reduplication",
				note: "वाली वाली = 'not that ordinary kind'. Do not collapse to one वाली."
			},
			{
				label: "Speech-act",
				note: "Directive + confirmation tag समझे? Rising."
			},
			{
				label: "Eval stance",
				note: "I annotate other voices the same way I annotate my own: verbatim, then judgement."
			}
		],
	...
	},
	{
		...
		scriptEn: "Two people in a control room arguing, politely, about over-processing. Clarity Vx removed noise and also presence. The correct RX move is a light Voice De-noise, not a full isolate. This is the human loop that AI tools still need.",
		transcript: "A: Bhāi, ye vocal thoṛā dry lag rahā hai. Room tone bilkul kāṭ diyā?\nB: Hā̃, Clarity se noise to gayā, lekin presence bhī kam ho gaī. RX mẽ Voice De-noise halkā calāte haĩ, pūrā nahī̃.\nA: Sahī kahā. AI tool madad kartā hai, lekin faislā kān kā hotā hai.\nB: Bilkul. Data mẽ bhī yahī cāhie — sāf, lekin insān jaisā.",
		annotations: [
			{
				label: "Speakers",
				note: "Two male, turn-taking, no heavy overlap. Diarise A/B."
			},
			{
				label: "Terms",
				note: "Clarity, RX, Voice De-noise, presence, room tone — keep English."
			},
			{
				label: "Thesis",
				note: "The sample is the argument: restoration is a taste decision, not a slider."
			}
		],
	...
	},
	{
		...
		lang: "hi",
		tags: ["Hindi"],
		scriptHi: "सेशन नोट. तारीख: उन्नीस सितम्बर, दो हज़ार छब्बीस. स्थान: ठाकुरनगर, पश्चिम बंगाल. सैंपल रेट: अड़तालीस किलोहर्ट्ज़. बिट डेप्थ: चौबीस बिट. चैनल: मोनो. माइक दूरी: पंद्रह सेंटीमीटर. पॉप फ़िल्टर और कार्डियोयिड पैटर्न. पीक हेडरूम: माइनस बारह डी बी एफ एस.",
		scriptEn: "A slate. Numerals, units, place names. This is how I would open a training take so a transcriber (or a model) cannot guess the capture chain.",
		transcript: "Session note. Tārīkh: unnīs sitambar, do hazār chabbīs. Sthān: Ṭhākurnagar, Paścim Bangāl. Sample rate: aṛtālīs kilohertz. Bit depth: caubīs bit. Channel: mono. Mic dūrī: pandrah centimeter. Pop filter aur cardioid pattern. Peak headroom: minus bārah dBFS.",
		annotations: [
			{
				label: "Numerals",
				note: "Spoken Indian Hindi numbers, not digit strings. Transcribe as spoken."
			},
			{
				label: "Entities",
				note: "Thakurnagar — named entity. Easy for ASR to miss."
			},
			{
				label: "Chain",
				note: "48 kHz / 24-bit / mono / 15 cm / cardioid / −12 dBFS peaks."
			}
		],
	...
	},
	{
		...
		scriptEn: "My name is Suvadeep Mallik. I am an audio production specialist with more than ten years of live sound and post-production experience. I listen for nuance: accent, intonation, sibilance, room tone, and whether a take is actually usable for training. Clean audio is not the same as useful audio. Useful audio keeps the human in the voice.",
		transcript: "My name is Suvadeep Mallik. I am an audio production specialist with more than ten years of live sound and post-production experience. I listen for nuance: accent, intonation, sibilance, room tone, and whether a take is actually usable for training. Clean audio is not the same as useful audio. Useful audio keeps the human in the voice.",
		annotations: [{
			label: "Delivery",
			note: "Clear, unhurried, Indian English. Suitable for instruction / VO."
		}, {
			label: "Thesis",
			note: "States the quality bar the rest of the portfolio demonstrates."
		}],
	...
	},
	{
		...
		transcript: "This take is usable, but not as gold speech. There is a generator rumble under one hundred hertz, a soft east Indian Hindi accent, and a filled pause before the word decision. I would keep the accent. I would annotate the rumble. I would not send this to a restoration model as if it were clean studio audio. That is the judgement call.",
		annotations: [{
			label: "Decision class",
			note: "Usable / not gold. Three separate tags: rumble, accent, filled pause."
		}, {
			label: "Policy",
			note: "Accent stays. Noise is annotated, not automatically removed."
		}],
...
var recordingCraft = {
	...
	specs: [
		{
			k: "Sample rate",
			v: "48 kHz speech / 44.1 kHz music"
		},
		{
			k: "Bit depth",
			v: "24-bit capture"
		...
		{
			k: "Pattern",
			v: "Cardioid, null to noise"
		},
		{
			k: "Export",
			v: "Mono WAV, normalize off"
		}
	]
};
var method = {
	title: "How I listen when the file is ambiguous",
	intro: "The JD asks for independent judgement on noisy or accented speech, and for transcription that holds disfluencies, accents, and prosody. This is the checklist I actually run. It is closer to a mastering listen than to a typing test.",
	steps: [
		{
			n: "01",
...
//#endregion
export { cn as a, jdFit as c, recordingCraft as d, restoration as f, certs as i, method as l, toolkit as m, Badge as n, education as o, samples as p, Button as r, experience as s, AudioPlayer as t, profile as u };
